...
import { useNowPlayingContext, SpotifyTrack } from "./NowPlayingContext";
...
/**
 * @deprecated Use useNowPlayingContext() from NowPlayingContext instead.
 * This is kept for backward compatibility.
 */
export function useNowPlaying() {
  const context = useNowPlayingContext();
  return {
    track: context.track,
    albumColor: context.albumColor,
