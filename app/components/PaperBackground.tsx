...
export default function PaperBackground() {
  return (
    ...
    >
      {/* cool moonlight haze across the top — dark mode only, sets the night */}
      <div
        className="absolute -top-64 left-1/2 h-[40rem] w-[80rem] -translate-x-1/2 rounded-full blur-3xl opacity-0 dark:opacity-[0.10]"
        style={{ background: "radial-gradient(circle, rgb(190 198 235) 0%, transparent 70%)" }}
      />
      {/* sunset-orange wash, top-left (a warm lamp at night) */}
      <div
        className="absolute -left-40 -top-48 h-[42rem] w-[42rem] rounded-full blur-3xl opacity-[0.10] dark:opacity-[0.20] animate-float"
        style={{ background: "radial-gradient(circle, rgb(var(--accent-orange)) 0%, transparent 68%)" }}
      />
      {/* flower-purple wash, bottom-right */}
      <div
        className="absolute -right-48 bottom-[-12rem] h-[46rem] w-[46rem] rounded-full blur-3xl opacity-[0.10] dark:opacity-[0.22] animate-float-delayed"
      ...
      <div
        className="absolute right-[20%] top-[28%] h-[26rem] w-[26rem] rounded-full blur-3xl opacity-[0.06] dark:opacity-[0.13]"
