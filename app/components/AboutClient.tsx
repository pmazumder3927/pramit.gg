...
export default function AboutClient() {
  const content = {
    ...
    intro: "Hey, I'm Pramit Mazumder. This is my digital space — a living journal where I share things that capture my attention",
    philosophy: "I believe in building things that feel personal and alive. This site is an experiment in that philosophy",
