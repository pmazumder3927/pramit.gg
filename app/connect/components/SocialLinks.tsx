...
export default function SocialLinks() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {socialLinks.map((link, index) => (
          ...
          >
            ...
            <div className={`absolute inset-0 bg-gradient-to-br ${link.color} opacity-0 group-hover:opacity-5 rounded-3xl transition-opacity duration-500`} />
            
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-4">
                <div className={`p-3 rounded-2xl bg-gradient-to-br ${link.color} bg-opacity-10 group-hover:bg-opacity-20 transition-all duration-300`}>
                  <div className={`text-transparent bg-gradient-to-br ${link.color} bg-clip-text`}>
                    {link.icon}
                  </div>
                </div>
                <div>
              ...
              <div className="flex items-center justify-between">
                ...
                <svg className="w-5 h-5 text-gray-600 group-hover:text-gray-400 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      >
        <p>
          each platform shows a different angle of the same story
        </p>
      </motion.div>
    </div>
  )
